...
public class HexiwearDevices {
    ...
    private static HexiwearDevices instance;

    Credentials_ credentials;
    Context context;

    public static HexiwearDevices getInstance(Context context){
        if(instance == null){
            instance = new HexiwearDevices(context);
        }
        return instance;
    }

    private HexiwearDevices(Context context) {
        init(context);
    }

    public void init(Context context) {
        this.context = context;
        this.credentials = new Credentials_(this.context);
        account = credentials.username().get();
        preferences = this.context.getSharedPreferences("HEX_" + account, Context.MODE_PRIVATE);
    }
